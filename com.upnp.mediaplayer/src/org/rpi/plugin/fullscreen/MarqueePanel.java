 ...
 *
 *  taken from http://www.camick.com/java/source/MarqueePanel.java
 */
public class MarqueePanel extends JPanel
        implements ActionListener, AncestorListener, WindowListener
{
    private static final Logger LOGGER = Logger.getLogger(MarqueePanel.class);
    ...
    private boolean scrollNeeded = true;
    ...
    public void startScrolling()
    {
        ...
        FontMetrics metrics = this.label.getFontMetrics(font);

        int childWidth = metrics.stringWidth(this.label.getText());
        int localWidth = this.getWidth();
