...
import org.openhome.net.device.providers.DvProviderAvOpenhomeOrgVolume4;
import org.openhome.net.device.providers.DvProviderAvOpenhomeOrgVolume1.Characteristics;
...
public class PrvVolumeV4 extends DvProviderAvOpenhomeOrgVolume4 implements Observer, IDisposableDevice {
	...
	public PrvVolumeV4(DvDevice iDevice) {
		super(iDevice);
