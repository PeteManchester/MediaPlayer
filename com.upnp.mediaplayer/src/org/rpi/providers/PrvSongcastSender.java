...
public class PrvSongcastSender extends DvProviderAvOpenhomeOrgSender1 implements  IDisposableDevice {
	
	private Logger log = Logger.getLogger(this.getClass());
	private String man_image =  "http://" + NetworkUtils.getIPAddress() + ":" + Config.getInstance().getWebServerPort() + "/images/mediaplayer240.png";
	private String meta_data = "<DIDL-Lite xmlns:dc=\"http://purl.org/dc/elements/1.1/\" xmlns:upnp=\"urn:schemas-upnp-org:metadata-1-0/upnp/\" xmlns=\"urn:schemas-upnp-org:metadata-1-0/DIDL-Lite/\"> <item id=\"0\" restricted=\"True\"> <dc:title>" + Config.getInstance().getMediaplayerFriendlyName() +"</dc:title>\" <res protocolInfo=\"ohz:*:*:u\">ohz://239.255.255.250:51972/"+ Config.getInstance().getMediaplayerFriendlyName() +"</res>  <upnp:albumArtURI>"+ man_image +"</upnp:albumArtURI>  <upnp:class>object.item.audioItem</upnp:class>  </item></DIDL-Lite>";

	public PrvSongcastSender(DvDevice arg0) {
		super(arg0);
