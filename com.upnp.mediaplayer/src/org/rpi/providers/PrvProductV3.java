...
import org.openhome.net.device.providers.DvProviderAvOpenhomeOrgProduct3;
...
public class PrvProductV3 extends DvProviderAvOpenhomeOrgProduct3 implements Observer, IDisposableDevice {
	...
	private String attributes = "Info Time Volume Receiver Sender Pins Transport";
	...
	public PrvProductV3(DvDevice iDevice) {
		super(iDevice);
	...
	@Override
	protected boolean standbyTransitioning(IDvInvocation paramIDvInvocation) {
		log.debug("standbyTransitioning: " +  Utils.getLogText(paramIDvInvocation));
		return false;
	}
