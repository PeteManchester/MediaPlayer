...
MediaPlayer also contains an Apple AirPlay receiver. The user may also create [custom input sources](https://github.com/PeteManchester/MediaPlayer/wiki/Custom-Sources).
